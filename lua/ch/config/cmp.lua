return {
  ...
  add_sources = function()
    ...
    require('ch.plugins').load_plugins(sources)
  end,
  setup = function(opts)
    vim.g.indentLine_conceallevel = 2
    vim.g.indentLine_concealcursor = "inc"

    require 'ch.plugins'.load 'nvim-cmp'
    ...
    local ok, lspkind = SR_L 'ch.plugin.lspkind'
    if ok then
    ...
    require 'ch.config.cmp'.add_sources()
