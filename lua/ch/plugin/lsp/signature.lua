...
H.signature_window_opts = function()
  local win_config = ch.lib.options:get('lsp', 'signature', 'window')

  local border_type = win_config.border or ch.config.ui.float_border
...
function M.show_signature_window()
  ...
  vim.lsp.util.stylize_markdown(H.signature.bufnr, lines, { wrap_at = ch.modules.ch.lsp.opts.signature.window.width })
