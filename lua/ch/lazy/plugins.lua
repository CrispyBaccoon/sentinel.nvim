return {
  { 'comfysage/chaivim', dir = ch.path.ch },
  { 'folke/lazy.nvim' },
  { name = 'keymaps', 'comfysage/keymaps.nvim' },
  { name = 'yosu', 'comfysage/yosu.nvim' },
  { 'comfysage/base46',
    cond = function() return ch.config.ui.base46 ~= nil and ch.config.ui.colorscheme == 'base46' end },
  ...
  { name = 'lualine', 'nvim-lualine/lualine.nvim',
    cond = function() return ch.lib.options:enabled 'lualine' end },
  ...
  { name = 'luasnip', 'L3MON4D3/LuaSnip',
    cond = function() return ch.lib.options:enabled 'luasnip' end,
    version = 'v2.*',
    dependencies = {
  ...
  { name = 'whichkey', 'folke/which-key.nvim',
    cond = function() return ch.lib.options:enabled 'whichkey' end },
  { name = 'todo_comments', 'folke/todo-comments.nvim',
    dependencies = 'nvim-lua/plenary.nvim',
    cond = function() return ch.lib.options:enabled 'todo_comments' end },
  { name = 'trouble', 'folke/trouble.nvim',
    cond = function() return ch.lib.options:enabled 'trouble' end },
  { name = 'incline', 'b0o/incline.nvim',
    cond = function() return ch.lib.options:enabled 'incline' end },
  { name = 'indent', 'lukas-reineke/indent-blankline.nvim',
    cond = function() return ch.lib.options:enabled 'indent' end },
  { name = 'fidget', 'j-hui/fidget.nvim',
    cond = function() return ch.lib.options:enabled 'fidget' end },
  { 'nvim-tree/nvim-web-devicons',
    cond = function() return ch.config.ui.devicons end },
  { import = ch.config.plugins },
}
