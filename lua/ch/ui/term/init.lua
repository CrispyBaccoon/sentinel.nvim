...
---@alias ch.types.ui.term.type 'horizontal'|'vertical'|'float'

---@class ch.types.ui.term.config
---@field enabled boolean
---@field terminals ch.types.ui.term.config.terminals
---@field ui ch.types.ui.term.config.ui

---@class ch.types.ui.term.terminal
---@field open boolean
---@field buf integer
---@field win integer
---@field job_id integer

---@class ch.types.ui.term.config.terminals
---@field list ch.types.ui.term.terminal[]

---@class ch.types.ui.term.config.ui
---@field float vim.api.keyset.win_config
---@field horizontal ch.types.ui.term.config.ui.split_opts
---@field vertical ch.types.ui.term.config.ui.split_opts
---@class ch.types.ui.term.config.ui.split_opts
...
M.set_behavior = function(behavior)
  if behavior.autoclose_on_quit.enabled then
    local function force_exit()
      require('ch.ui.term.terminal').close_all_terms()
      api.nvim_command 'qa'
    end
    api.nvim_create_autocmd({ 'WinClosed' }, {
      callback = vim.schedule_wrap(function()
        local open_terms =
          require('ch.ui.term.terminal').list_active_terms 'win'
...
M.setup = function(opts)
  require('ch.ui.term').set_behavior(opts.behavior)
  require('ch.ui.term.terminal').init(opts.terminals)
end
...
M.setup_keymaps = function(opts)
  Keymap.group {
    group = 'terminal',
    {
      ...
      function()
        require('ch.ui.term.terminal').toggle 'float'
      end,
    ...
    },
    {
      ...
      function()
        require('ch.ui.term.terminal').toggle 'vertical'
      end,
    ...
    },
    {
      ...
      function()
        require('ch.ui.term.terminal').toggle 'horizontal'
      end,
